...
echo "<h2>🔐 Password Hash Generator - Waste Management</h2>";
echo "<hr>";
...
echo "USE waste_management;\n\n";
echo "UPDATE admins SET password = '$hash' WHERE username = 'admin';\n\n";
echo "-- Verify the update\n";
echo "SELECT id, username, fullname, LEFT(password, 30) as password_preview FROM admins;\n";
echo "</pre>";
echo "</div>";
